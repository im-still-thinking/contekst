...
function setupContinuousMonitoring() {
  console.log('Setting up continuous monitoring for context button and send button interception...');
  ...
  console.log('Continuous monitoring active for context button and send interception');
}
